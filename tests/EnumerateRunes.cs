...
namespace System.SpanTests
{
    public static partial class SpanTests
    {
        ...
        {
            Assert.False(SpanExtensions.EnumerateRunes(ReadOnlySpan<char>.Empty).GetEnumerator().MoveNext());
            Assert.False(SpanExtensions.EnumerateRunes(Span<char>.Empty).GetEnumerator().MoveNext());
        }
